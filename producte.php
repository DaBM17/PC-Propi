...
<header>
    ...
    <div id="compra">
        <a href="cabas.php"><img src="img/basket-cart-icon-27.png" alt="Compra" id="shopping_cart" width="300px"></a>
    </div>
</header>
<?php
    include_once __DIR__ . "/controlador/mostrarDades.php";

    $prodID = $_GET['prodID'];
    $prodID = pg_escape_string($prodID);

    mostrarDadesProducte($prodID);
?>
<footer>
    <a href="https://www.uab.cat/"><img src="img/UAB-2linies-verd.svg" width="300px"></a>
    <?php
    if (isset($_SESSION['email'])) { ?>
        <p id='cabas'>Productes al cabàs: <?php echo $_SESSION['num_productes']; ?> | Import: <?php echo $_SESSION['import_total']; ?>€ </p>
    <?php  } ?>
